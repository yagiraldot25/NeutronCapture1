...
N1Material* N1Material::instance = NULL ;


N1Material::N1Material()
{
...
N1Material* N1Material::GetInstance() {

	if (instance == NULL) instance =  new N1Material() ;
	return instance ;

}

void N1Material::Kill() {
...
G4Material* N1Material::GetMaterial(const G4String materialName){
...
G4Material* N1Material::GetMaterial(const G4String materialName, const G4double concentration){
...
G4Material* N1Material::otherMaterials(const G4String materialName)
{
...
G4Material* N1Material::otherMaterials(const G4String materialName, const G4double concentration)
{
	G4Material * material = 0;
